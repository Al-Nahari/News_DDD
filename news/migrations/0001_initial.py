    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.URLField(blank=True, max_length=1000, null=True, verbose_name='صورة مميزة')),
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles', to='accounts.author', verbose_name='المؤلف')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles', to='news.category', verbose_name='التصنيف')),
                ('tags', models.ManyToManyField(blank=True, related_name='articles', to='news.tag', verbose_name='الوسوم')),
            ],
            options={
                'verbose_name': 'مقال',
